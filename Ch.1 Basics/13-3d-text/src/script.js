...
fontLoader.load(
    ...
    (font) => {
        ...
        // Faster way (easier way) of centering text
        textGeometry.center()
        ...
        //Move these from inside the loop for optimized performace
        ...
        for(let i = 0; i < 150; i++){
            ...
            //Changing rotation of donuts 
            donut.rotation.x = Math.random() * Math.PI
            donut.rotation.y = Math.random() * Math.PI

            //Scaling the donut to different size 
